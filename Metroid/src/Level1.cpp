...
void Level1::load() {
  ...
  //  bulletObject2 = std::unique_ptr<Bullet>(new Bullet(std::move(projectiel2)));
    ...
    std::vector<unsigned short int> lvl1Map = {
            ...
            0x0001,0x0001,0x1004,0x0005,0x1004,0x0005,0x1004,0x0005,
            0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,
            0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,
            0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,
            0x0003,0x0003,0x0006,0x0007,0x0006,0x0007,0x0006,0x0007,
            0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,
            0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,
            ...
            0x0003,0x0003,0x0006,0x0007,0x0006,0x0007,0x0006,0x0007,
            0x0000,0x0000,0x1004,0x0005,0x0000,0x0000,0x0000,0x0000,
            0x1004,0x0005,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,
            0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0003,0x0003,
            ...
            0x0005,0x0000,0x0000,0x0000,0x0000,0x0000,0x0003,0x0003,
            ...
            0x0002,0x1008,0x1008,0x1009,0x1009,0x0001,0x0001,0x1004,
            0x0005,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,
            0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,

            0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0002,
            0x0002,0x100A,0x100A,0x000B,0x000B,0x0003,0x0003,0x0006,
            ...
            0x0002,0x0002,0x0002,0x0002,0x0002,0x0002,0x0002,0x0002,
            0x0002,0x0002,0x0002,0x0002,0x0002,0x0002,0x0002,0x0002,
            0x000C,0x000C,0x000C,0x000C,0x000C,0x000C,0x0001,0x0001,
            0x0002,0x0002,0x0002,0x0002,0x0002,0x0002,0x0002,0x0002,
            0x0002,0x0002,0x0002,0x0002,0x0002,0x0002,0x0002,0x0002,
            0x0002,0x0002,0x0002,0x0002,0x0002,0x0002,0x0002,0x0002,
            0x000C,0x000C,0x000C,0x000C,0x000C,0x000C,0x0003,0x0003,
            ...
            0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0001,0x0001,
            0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,
            0x0000,0x0000,0x0000,0x0000,0x0003,0x0003,0x0000,0x0000,
            0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,
            0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0003,0x0003,
            ...
            0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,
            0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,
            0x0000,0x0000,0x0000,0x0000,0x0000,0x1004,0x0005,0x0000,
            0x0000,0x0000,0x0000,0x0000,0x0003,0x0003,0x0000,0x0000,
            0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,
            0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,

            0x0000,0x0000,0x0000,0x0000,0x0000,0x0006,0x0007,0x0000,
            0x0000,0x0000,0x0000,0x0000,0x0001,0x0001,0x0000,0x0000,
            0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,
            0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,
            0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,
  ...
  //  TextStream::instance().setText(std::to_string(right),11,1);
    ...
    if (bg->getScrollX() + metroidObject->getMetroid()->getX() == 470){
        ...
        if (!engine->isTransitioning()) {
            ...
            engine->transitionIntoScene(new Menu(engine), new FadeOutScene(6));
        }
    }
}
